...
public void createGUI(){
  ...
  lblAirResistanceStage1.setText("Resistencia del aire (en Newtons)");
  ...
  lblParatrooperWeightStage1.setText("Peso del paracaidista (En kilogramos)");
  ...
  lblFormulaPart1Stage1 = new GLabel(stageWindow1, 0, 414, 1150, 20);
  lblFormulaPart1Stage1.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  lblFormulaPart1Stage1.setText("Formula Parte 1");
  lblFormulaPart1Stage1.setOpaque(false);
  lblFormulaPart2Stage1 = new GLabel(stageWindow1, 0, 442, 1151, 20);
  lblFormulaPart2Stage1.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  lblFormulaPart2Stage1.setText("Formula parte 2");
  lblFormulaPart2Stage1.setOpaque(false);
  lblFormulaPart3Stage1 = new GLabel(stageWindow1, 0, 469, 1150, 20);
  lblFormulaPart3Stage1.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  ...
  label19.setText("Peso del paracaidista (En kilogramos)");
  label19.setOpaque(false);
  label20 = new GLabel(stageWindow2, 108, 157, 394, 20);
  label20.setText("Resistencia del aire (En newtons)");
  ...
  lblBuildingHeight.setText("Altura del edificio (En metros)");
  ...
  label8.setText("Altura (En metros)");
